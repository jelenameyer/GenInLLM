#!/usr/bin/env python3
"""
Model Manager - Main orchestrator for running multiple survey and behavioural tasks across multiple LLM models (instuction fine-tuned decoder).
...
MODEL_CONFIGS = {
    ...
    # --- Liquid AI --- Wohlmöglich nicht instruction fine-tuned??
    "LFM2-1.2B": {
        "model_key": "LFM2-1.2B",
